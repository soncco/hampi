...
urlpatterns = patterns('front.views',
  ...
  url(r'^venta/factura/printx/(?P<id>.*)$', 'venta_factura_print', name = 'venta_factura_print'),
  url(r'^venta/factura/print/(?P<id>.*)$', 'venta_factura_print2', name = 'venta_factura_print2'),
