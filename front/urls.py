...
urlpatterns = patterns('front.views',
  ...
  url(r'^venta/guia/printx/(?P<id>.*)$', 'venta_guia_print_antiguo', name = 'venta_guia_print_antiguo'),
  url(r'^venta/guia/print/(?P<id>.*)$', 'venta_guia_print', name = 'venta_guia_print'),
  url(r'^venta/factura/printx/(?P<id>.*)$', 'venta_factura_print_antiguo', name = 'venta_factura_print_antiguo'),
